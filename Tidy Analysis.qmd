...
```{sql, connection = dbconn, output.var = "sql-Riders_monthly"}
...
queryResult <- duckdb::dbSendQuery(conn = dbconn,
                                   statement = sql - bikeType_count)

duckdb::dbFetch(queryResult) |>
    ggplot2::ggplot() +
    ...
    ggplot2::labs(title = "Rental Count - by Type",
