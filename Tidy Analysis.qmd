...
tempfile_paths <- sprintf("tempFiles/%d-divvy-tripdata.parquet",
                      202301:202312)
...
tripset |>
    arrow::write_dataset(path = "tripdata",
                         format = "parquet")

    unlink(c(tempFiles,tempZips),
           recursive = TRUE)
...
matrix(parquetFileList,
       dimnames = list(seq(parquetFileList),
                       c("Parquets")))
```
