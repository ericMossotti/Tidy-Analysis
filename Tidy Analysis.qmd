...
duckdb::dbRemoveTable(dbconn, "cleanTripdata")
#    duckdb::dbWriteTable(conn = dbconn,
#                         name = "cleanTripdata")
...
dplyr::tbl(dbconn,
         "trip_tbl2") |>
    dplyr::select("ride_id") |>
    dplyr::count(name = "Total Observations Originally")
...
By applying distinct() on dupTibble, we see the only distinct value is 2. We can safely conclude that, of the duplicates, each has a mininum and maximum of 1 extra copy.
