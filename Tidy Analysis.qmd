...
# A custom function that makes unzipping, converting, and relocating files all at once easy and fun. Wanted to save space by converting the CSVs within to Parquet before relocating to project folder's on disk memory. 
