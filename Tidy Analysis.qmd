...
rCounts_types <- dplyr::tbl(duckCon,
                            "duckbase") |>
    dplyr::group_by(rideable_type) |>
...
dplyr::tbl(duckCon,
    ...
    as.data.frame() |>
    duckdb::dbWriteTable(conn = duckCon,
                         name = "Counts_By_Month::Casual Riders")
```
...
dplyr::tbl(duckCon,
    ...
    as.data.frame() |>
    duckdb::dbWriteTable(conn = duckCon,
                         name = "Counts_By_Month::Annual Members")
```
...
dplyr::tbl(duckCon,
    ...
    as.data.frame() |>
    duckdb::dbWriteTable(conn = duckCon,
                         name = "Counts_By_Month::Casual eBikers")
```
...
dplyr::tbl(duckCon,
    ...
    dplyr::filter(member_casual == "member",
                  rideable_type == "electric_bike") |>
    dplyr::summarize(MembersOnElectric = count(member_casual)) |>
    as.data.frame() |>
    duckdb::dbWriteTable(conn = duckCon,
                         name = "Counts_By_Month::Annual Member eBikers")
...
dplyr::tbl(duckCon,
    ...
    dplyr::summarize(Classic_Annuals = count(member_casual)) |>
    as.data.frame() |>
    duckdb::dbWriteTable(conn = duckCon,
                         name = 
...
dplyr::tbl(duckCon,
    ...
    dplyr::filter(member_casual == "casual",
                  rideable_type == "classic_bike") |>
    dplyr::summarize(Classic_Casuals = count(member_casual)) |>
    as.data.frame() |>
    duckdb::dbWriteTable(conn = duckCon,
                         name = 
...
dplyr::tbl(duckCon,
    ...
    dplyr::left_join(y = dplyr::tbl(duckCon,
                                    "Counts_By_Month::Casual Riders")) |>
    dplyr::left_join(y = dplyr::tbl(duckCon,
                                    "Counts_By_Month::Annual Members")) |>
    dplyr::left_join(y = dplyr::tbl(duckCon,
                                    "Counts_By_Month::Casual eBikers")) |>
    dplyr::left_join(y = dplyr::tbl(duckCon,
                                    "Counts_By_Month::Annual Members eBikers")) |>
    dplyr::left_join(y = dplyr::tbl(duckCon,
                                    "Counts_By_Month::Casuals::Classic Bikers")) |>
    dplyr::left_join(y = dplyr::tbl(duckCon,
                                    "Counts_By_Month::Annual Members::Classic Bikers"))
