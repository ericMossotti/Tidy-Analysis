...
```{r}
# new table, from duckbase
monthly_stats <- dplyr::tbl(duckCon,
                            "tbl_eMembers") |>
...
df <- as.data.frame(rCounts_monthlyRides)

duckdb::dbWriteTable( duckCon,
                      "MonthlyCounts",
                      df)
...
duckdb::dbListFields(duckCon, "MonthlyCounts")
```
