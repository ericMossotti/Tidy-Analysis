...
local_zipNames <- sprintf ( "tripZips/%d-divvy-tripdata.zip",
                      202301:202312 )

multi_download ( durls, destfiles = zipNames_local )

dir.create("tripdata")

local_fileNames <- sprintf ( "tripdata/%d-divvy-tripdata.csv",
                             202301:202312)

for ( i in 1:12 ) {
    
        unzip ( local_zipNames[i], local_fileNames[i] )
}
